...
public class Main {
    public static void main(String[] args) {
        ...
        roti.setnamaHidangan("Roti Tawar Tcap Makima ");
        Minuman susu = new Minuman();
        susu.setnamaHidangan("Susu manis tcap mama ganyu ");
        breakfast.setKonsumsi(roti,susu);
        listKonsumsi.add(breakfast);

        Makanan nasi = new Makanan();
        nasi.setnamaHidangan("Nasi lemak tcap kak ros ");
        Minuman air = new Minuman();
        air.setnamaHidangan("air bekas makima ");
